...
export const DataGrid = (theme: Theme): Components['MuiDataGrid'] => {
  return {
    defaultProps: {
      slotProps: {
    ...
    styleOverrides: {
      root: { border: 0 },
      columnHeaders: { borderBottom: 0 },
      iconSeparator: { color: theme.palette.grey[400] },
      cell: {
        borderBottom: 0,
        ':focus': { outline: 0 },
      },
