  ...
  return {
    ...
    styleOverrides: {
      ...
      containedInherit: {
        ...
        ...theme.applyStyles('dark', { color: 'black' }),
      },

      // outlined variants
      outlinedError: { color: theme.palette.error.main },
      outlinedPrimary: { color: theme.palette.primary.main },
      outlinedSuccess: { color: theme.palette.success.main },
      outlinedWarning: { color: theme.palette.warning.main },
      outlinedSecondary: {
        transition: 'none',
      ...
      textSecondary: { color: theme.palette.grey[600] },
      ...
      // sizes
      sizeSmall: { padding: '0.25rem .5rem', height: 30, lineHeight: 1.5 },
