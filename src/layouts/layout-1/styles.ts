...
type CollapseCompact = ActiveCompact & { collapsed: boolean }
// ==============================================================
...
// COMMON ICON STYLE
export const ICON_STYLE = (active: boolean) => ({
  fontSize: 18,
...
export const BulletIcon = styled('div', {
  ...
  ...(active && {
    ...
    ...theme.applyStyles('dark', { boxShadow: `0px 0px 0px 3px ${theme.palette.grey[700]}` }),
  }),
}))
