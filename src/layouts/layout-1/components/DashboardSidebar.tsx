...
const SidebarContent = memo(({ isCompact }: { isCompact: boolean }) => (
  <Scrollbar
    autoHide
    clickOnTrack={false}
    sx={{
...
const SidebarHeader = memo(({ isCompact, onToggle }: SidebarHeaderProps) => (
...
const CollapseButton = memo(({ onClick }: { onClick: () => void }) => (
