export const PAGES_MENUS = [
  {
    ...
    child: [
      ...
      { id: 10, title: 'Analytics 2', href: '/dashboard/analytics-2' },
      ...
      { id: 9, title: 'Job Management', href: '/dashboard/job-management' },
    ],
  },
  {
    id: 2,
    ...
    child: [
      ...
      { id: 6, title: 'Job Details', href: '/career/designer' },
      { id: 7, title: 'Apply Job', href: '/career/designer/apply' },
      { id: 8, title: 'Shop', href: '/products' },
      { id: 9, title: 'Checkout', href: '/checkout' },
