...
export default function RegisterView() {
  ...
  const { createUserWithEmail, isAuthenticated, user } = use(AuthContext)
  ...
  return (
    <Layout>
      <Box maxWidth={550} p={4}>
        <Typography variant="body1" fontWeight={600} lineHeight={1} fontSize={{ sm: 30, xs: 25 }}>
        ...
        <Button
          fullWidth
          variant="text"
          onClick={() => router.push('/firebase/login')}
