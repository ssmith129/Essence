...
const STATUS_COLORS = [
  { value: '#61A9FF', color: 'primary' },
  { value: '#2CC5BD', color: 'success' },
  { value: '#FD396D', color: 'error' },
  { value: '#A798FF', color: 'info' },
]
            ...
            <Stack spacing={1}>
              ...
              <FlexBox alignItems="center">
                ...
                <RadioGroup
                  row
                  name="statusColor"
                  value={watch('statusColor')}
                  onChange={(e) => setValue('statusColor', e.target.value)}
                >
                  {STATUS_COLORS.map(({ value, color }) => (
                    <Radio
                      key={value}
                      value={value}
                      size="small"
