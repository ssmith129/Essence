  ...
  return (
    <div className="py-12">
      <Container maxWidth="lg">
        <Grid container spacing={{ lg: 6, xs: 3 }}>
          <Grid size={{ lg: 7, md: 6, xs: 12 }}>
            <CarouselRoot>
              <Carousel
                ...
                slidesToShow={1}
                ref={carouselRef}
                afterChange={(slideNo) => setSelectedSlide(slideNo)}
              >
                {[0, 1, 2].map((item) => (
                  <img
                    key={item}
                    className="slide"
                    src="/static/products/rayban-glass-2.jpg"
                    alt="product"
                  />
                ))}
              </Carousel>
            ...
            <Stack justifyContent="center" direction="row" spacing={2} mt={1}>
              {[0, 1, 2].map((item, index) => (
                ...
                >
                  <img src="/static/products/rayban-glass-2.jpg" alt="product" />
                </SlideThumb>
              ))}
            </Stack>
          </Grid>
