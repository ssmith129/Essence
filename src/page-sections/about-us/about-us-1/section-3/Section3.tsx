...
export default function Section3() {
  ...
  const responsive = [
    { breakpoint: breakpoints.values.lg, settings: { slidesToShow: 3 } },
    { breakpoint: breakpoints.values.md, settings: { slidesToShow: 2 } },
    { breakpoint: breakpoints.values.sm, settings: { slidesToShow: 1 } },
  ]
