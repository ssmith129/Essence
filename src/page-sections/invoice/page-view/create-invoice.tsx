...
export default function CreateInvoicePageView() {
  ...
  const handleCancel = useCallback(() => router.push('/dashboard/invoices/invoice-list'), [router])
        ...
        <FormProvider methods={methods} onSubmit={handleSubmitForm}>
          <StatusWrapper>
            ...
            <div className="buttonWrapper">
              <Button color="secondary" variant="outlined" onClick={handleCancel} sx={{ mr: 1 }}>
                Cancel
              </Button>
