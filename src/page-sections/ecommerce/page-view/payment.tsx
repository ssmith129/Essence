...
export default function PaymentPageView() {
  ...
  const handleChangePaymentMethod = useCallback((event: ChangeEvent<HTMLInputElement>) => {
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ md: 8, xs: 12 }}>
          <Card className="p-3">
            ...
            <FlexBox alignItems="center" gap={1} mt={2}>
              <Radio
                ...
                checked={selectPaymentMethod === PAYMENT_METHODS.PAYPAL}
              />
            ...
            <FlexBox alignItems="center" gap={1}>
              <Radio
                ...
                onChange={handleChangePaymentMethod}
                checked={selectPaymentMethod === PAYMENT_METHODS.CARD}
              />
              ...
              <FlexBetween flexGrow={1}>
                ...
                <FlexBox gap={1}>
                  {['Visa', 'MasterCard', 'AmericanExpress'].map((card) => (
                    <img key={card} src={`/static/payment/${card}.svg`} alt={`${card} Card`} />
                  ))}
                </FlexBox>
              </FlexBetween>
            </FlexBox>
            ...
            <FlexBox alignItems="center" gap={1}>
              <Radio
                ...
                onChange={handleChangePaymentMethod}
                checked={selectPaymentMethod === PAYMENT_METHODS.CASH}
              />
          ...
          <Box mt={2}>
            <Button
              ...
              onClick={() => router.push('/dashboard/billing-address')}
            >
              Back
            </Button>
          </Box>
        ...
        <Grid size={{ md: 4, xs: 12 }}>
          ...
          <OrderSummery
            ...
            handleClick={() => router.push('/dashboard/payment-complete')}
          />
        </Grid>
      </Grid>
    </div>
