      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ md: 8, xs: 12 }}>
          <Card>
            ...
            <Scrollbar autoHide={false}>
              <Table sx={{ minWidth: 600 }}>
                ...
                <TableBody>
                  {cartList.map((cart) => (
                    <CartTableRow item={cart} key={cart.id} />
                  ))}
                </TableBody>
              </Table>
            </Scrollbar>
          ...
          <Box mt={2}>
            <Button
              ...
              onClick={() => router.push('/dashboards/shop')}
            >
              Continue Shopping
            </Button>
          </Box>
        ...
        <Grid size={{ md: 4, xs: 12 }}>
          <OrderSummery
            ...
            handleClick={() => router.push('/dashboard/billing-address')}
          />
        </Grid>
      </Grid>
    </div>
...
const CartTableRow = memo(function ({ item }: { item: CartItem }) {
  return (
    <TableRow>
      <BodyTableCell>
        <FlexBox gap={1.5} alignItems="center">
          ...
          <div>
            ...
            <Typography variant="body2" fontSize={13} sx={{ span: { color: 'text.primary' } }}>
