  ...
  return <div className="pt-2 pb-4">
      <Grid container spacing={3}>
        ...
        xs: 12
          ...
          <Box mt={2}>
            <Button disableRipple variant="text" startIcon={<ChevronLeft />} onClick={() => router.push('/dashboards/shop')}>
              Continue Shopping
            </Button>
          </Box>
        </Grid>
        ...
        xs: 12
          ...
          <OrderSummery showCoupon buttonText="Check Out Now" handleClick={() => router.push('/dashboard/billing-address')} />
        </Grid>
      </Grid>
    </div>;
}
