...
const REVIEWS = [
  {
    ...
    comment:
      'Thank you very fast shipping from Poland only 3days. Very Grateful. Was this review helpful to you?.',
  ...
  },
  {
    ...
    rating: 4,
    createdAt: '14 Nov, 2021',
    user: { name: 'Christina Perry', image: '/static/user/user-15.png' },
    comment:
      'Thank you very fast shipping from Poland only 3days. Very Grateful. Was this review helpful to you?.',
  },
  {
    ...
    rating: 4,
    createdAt: '14 Nov, 2021',
    user: { name: 'Christina Perry', image: '/static/user/user-17.png' },
    comment:
      'Thank you very fast shipping from Poland only 3days. Very Grateful. Was this review helpful to you?.',
  },
]
    ...
    <ContainerGrid container>
      ...
      <Grid size={{ md: 4, xs: 12 }}>
        <Stack alignItems="center" p={3}>
          ...
          <Typography variant="h3" fontWeight={700} sx={{ my: 1, color: 'primary.main' }}>
            4/5
          </Typography>
