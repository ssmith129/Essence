...
const TRANSACTIONS = [
  {
    ...
    user: { id: 11, name: 'Arikunn', image: '/static/user/user-13.png' },
  },
  {
    id: 2,
    total: 165.58,
    createdAt: new Date('August 30, 2022 13:30:00'),
    user: { id: 21, name: 'Ikauwis', image: '/static/user/user-14.png' },
  },
  {
    id: 3,
    total: 463.25,
    createdAt: new Date('August 29, 2022 19:30:00'),
    user: { id: 31, name: 'Dayet', image: '/static/user/user-15.png' },
  },
  {
    id: 4,
    total: 185.58,
    createdAt: new Date('August 28, 2022 16:30:00'),
    user: { id: 41, name: 'Ikauwis', image: '/static/user/user-13.png' },
  },
]
