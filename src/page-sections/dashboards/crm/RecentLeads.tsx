...
const DATA = [
  {
    ...
    user: { name: 'Astole Banne', balance: 25360.0, image: '/static/user/user-11.png' },
  },
  {
    id: nanoid(),
    status: 'Cold Lead',
    ...
    user: { name: 'Taslon Abela', balance: 25360.0, image: '/static/user/user-17.png' },
  },
  {
    id: nanoid(),
    status: 'New Lead',
    ...
    user: { name: 'Tofan Andy', balance: 25360.0, image: '/static/user/user-18.png' },
  },
]
