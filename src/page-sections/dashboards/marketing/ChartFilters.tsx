...
export default function ChartFilters() {
  ...
  const handleChange = useCallback((id: string) => () => setSelectedItem(id), [])
...
function Stat({ amount, percentage, description }: StatProps) {
  return (
    <div>
      <FlexBox alignItems="center" gap={1}>
        ...
        {percentage > 0 ? (
          <Percentage type="success">+{percentage}%</Percentage>
        ) : (
          <Percentage type="error">{percentage}%</Percentage>
        )}
      </FlexBox>
