...
export const LIST_ITEMS = [
  { value: 0, Icon: Mail, id: nanoid(), title: 'All Mail', url: '/dashboard/email/all' },
  { value: 16, Icon: Inbox, id: nanoid(), title: 'Inbox', url: '/dashboard/email/inbox' },
  { value: 0, Icon: SendTwoTone, id: nanoid(), title: 'Sent', url: '/dashboard/email/sent' },
