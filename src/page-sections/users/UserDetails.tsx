...
const NoDataBox = styled('div')(({ theme }) => ({
  height: '100%',
  display: 'flex',
  alignItems: 'center',
        ...
        <Fragment>
          <FlexBetween mt={4}>
            <IconButton size="small" onClick={handleEdit}>
              <Edit sx={{ color: 'text.secondary', fontSize: 18 }} />
            </IconButton>

            <IconButton size="small" onClick={(e) => setAnchorEl(e.currentTarget)}>
              <MoreHorizontal sx={{ color: 'text.secondary', fontSize: 18 }} />
            </IconButton>
...
function ListItem({ Icon, title }: ListItemProps) {
  return (
    <Stack direction="row" spacing={1} alignItems="center" pb={3}>
