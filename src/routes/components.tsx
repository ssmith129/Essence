...
export const ComponentRoutes = [
  {
    ...
    children: [
      { element: <Components />, index: true },
      { path: 'accordion', element: <MuiAccordion /> },
      { path: 'alert', element: <MuiAlert /> },
      { path: 'autocomplete', element: <MuiAutocomplete /> },
      { path: 'avatar', element: <MuiAvatar /> },
      { path: 'badge', element: <MuiBadge /> },
      { path: 'breadcrumbs', element: <MuiBreadcrumbs /> },
      { path: 'buttons', element: <MuiButtons /> },
      { path: 'checkbox', element: <MuiCheckbox /> },
      { path: 'chip', element: <MuiChip /> },
      { path: 'data-grid', element: <MuiDataGrid /> },
      { path: 'dialog', element: <MuiDialog /> },
      { path: 'list', element: <MuiList /> },
      { path: 'menu', element: <MuiMenu /> },
      { path: 'pagination', element: <MuiPagination /> },
      { path: 'pickers', element: <MuiPickers /> },
      { path: 'popover', element: <MuiPopover /> },
      { path: 'progress', element: <MuiProgress /> },
      { path: 'radio-button', element: <MuiRadioButton /> },
      { path: 'rating', element: <MuiRating /> },
      { path: 'slider', element: <MuiSlider /> },
      { path: 'stepper', element: <MuiStepper /> },
      { path: 'switch', element: <MuiSwitch /> },
      { path: 'table', element: <MuiTable /> },
      { path: 'tabs', element: <MuiTabs /> },
      { path: 'textfield', element: <MuiTextField /> },
      { path: 'timeline', element: <MuiTimeline /> },
      { path: 'tooltip', element: <MuiTooltip /> },
      { path: 'transfer-list', element: <MuiTransferList /> },
      { path: 'tree-view', element: <MuiTreeview /> },
      { path: 'snackbar', element: <MuiSnackbar /> },
    ],
  },
]
