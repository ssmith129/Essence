...
export const AuthRoutes = [
  ...
  },
  {
    path: 'jwt',
    children: [
      { path: 'login', element: <LoginDemoWithJWT /> },
      { path: 'register', element: <RegisterDemoWithJWT /> },
    ],
  },
  {
    path: 'firebase',
    children: [
      { path: 'login', element: <LoginDemoWithFirebase /> },
      { path: 'register', element: <RegisterDemoWithFirebase /> },
    ],
  },
  {
    path: 'amplify',
    children: [
      { path: 'login', element: <LoginDemoWithAmplify /> },
      { path: 'register', element: <RegisterDemoWithAmplify /> },
      { path: 'verify', element: <VerifyDemoWithAmplify /> },
    ],
  },
]
